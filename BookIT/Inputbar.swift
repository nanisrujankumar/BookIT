...
let LEFT_BUTTON_SIZE:CGFloat = 0
...
class Inputbar: UIToolbar, HPGrowingTextViewDelegate {
    ...
    func addTextView() {
        ...
        self.textView = HPGrowingTextView(frame:CGRect(x:LEFT_BUTTON_SIZE+15,
                                                       y:5,
                                                       width:size.width - LEFT_BUTTON_SIZE - RIGHT_BUTTON_SIZE - 10,
                                                       height:size.height))
