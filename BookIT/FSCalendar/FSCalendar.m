...
- (void)initialize
{
    ...
    _maximumDate = [self dateByAddingWeeks:1 toDate:_minimumDate];
    //_maximumDate = [self dateByAddingMonths:1 toDate:_minimumDate];
#else
    _minimumDate = [NSDate date];
 //   _maximumDate = [self dateByAddingMonths:1 toDate:_minimumDate];
    _maximumDate = [self dateByAddingWeeks:1 toDate:_minimumDate];
    //[self dateWithYear:2099 month:12 day:31];
#endif
